...
const deserializeVideos = function(videos) {
	videos.forEach(v => { // nasi tags nemaju id otud ovo
		v.attributes.tag_ids = v.relationships.tags.data.map(t => t.id)
	})
}
